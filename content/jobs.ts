export const jobs = [
  {
    ...
    content: `Als Empirical Data Scientist identifizierst Du die wichtigen Signale im wachsenden Datenrauschen und führst sie zu handlungsrelevanten Strategien.
  
## Du bringst mit
- Berufserfahrung als (Junior) Data Scientist oder im Umgang mit Daten
- Forschergeist und Freude daran, mithilfe statistischer Tools (z. B. SPSS, R) in großen Datenmengen die Signale im Datenrauschen zu identifizieren
...
- Hervorragenden Zusammenhalt und wer Lust hat: regelmäßige gemeinsame Aktionen draußen und drinnen

Wir freuen uns auf Deine aussagekräftige Bewerbung (mit Anschreiben, Lebenslauf, Zeugnissen und einer konkreten Gehaltsvorstellung), bitte per E-Mail an Anna Begau.`,
  },
  {
    id: 'it-administrator-in',
    title: 'IT-Administrator*in',
    contactImage: {
...
- Eine schnelle Auffassungsgabe sowie eine pragmatische Denkweise

## Du findest bei uns
- Individuelle Fortbildung und Freiraum zur Entwicklung von Kompetenzen und Persönlichkeit
- Abwechslungsreiche und anspruchsvolle Aufgaben
- Die Möglichkeit, einen Arbeitsbereich aktiv zu gestalten
- Hervorragender Zusammenhalt im Team
- Regelmäßiges Feedback, wertschätzender und offener Umgang, Arbeit auf Augenhöhe
- Technologien auf neuestem Stand
- Moderne und agile Arbeitsweisen
- Eine hervorragende Balance zwischen der Arbeit in dynamischen Umfeldern und der eigenen Regeneration
- (Pandemiebedingt) Arbeit bevorzugt im Homeoffice, flexible Arbeitszeiten
- Sehr schöne Büroräume mit guter Atmosphäre, bestem Tee und Kaffee

Wir freuen uns auf Deine aussagekräftige Bewerbung, bevorzugt per E-Mail.`,
  },
  {
    id: 'werkstudent-fuer-it-systemarchitektur',
    title: 'Werkstudent (m/w/d) für IT-Systemarchitektur',
    contactImage: {
      src: '/images/team/portraits/_VND5596.jpg',
      width: 696 / 4,
      height: 975 / 4,
...
Wir freuen uns auf Deine aussagekräftige Bewerbung, bevorzugt per E-Mail.`,
  },
  {
    ...
    content: `aserto begleitet Unternehmen und Institutionen bei richtungsweisenden Entscheidungen, vorwiegend bei Fragen von Kommunikation, Marketing und Innovation. Als Projektmitarbeiter*in arbeitest Du in (empirischen) Projekten mit und gewinnst wertvolle Einblicke in die Praxis.
