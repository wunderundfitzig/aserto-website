  ...
  return (
    <section className='impressum'>
      ...
      <List color={colors.grey}>
        ...
        <li>
          <div>
            <h3>Umsatzsteueridentifikationsnummer: DE 226703901</h3>
          </div>
        </li>
        <li>
          <div>
...
'
        ...
        <li>
          <div>
            ...
            <p>
              ...
              Service des Unternehmens. Für Richtigkeit, Vollständigkeit und
              Aktualität kann aserto jedoch keine Haftung übernehmen. Die
            ...
            <p>
              ...
              aserto hat keinerlei Einfluss auf die aktuelle und zukünftige
              Gestaltung, sowie auf die Inhalte der verknüpften Seiten. Das
              Setzen von externen Links bedeutet nicht, dass sich aserto die
              hinter dem Verweis oder Link liegenden Inhalte zu Eigen macht.
              Eine ständige Kontrolle der externen Links ist für aserto ohne
            ...
            <p>
              Des Weiteren kann die Internetseite von aserto ohne das Wissen des
              Unternehmens von einer anderen Seite mittels Hyperlink verlinkt
              worden sein. aserto übernimmt keine Verantwortung für Darstellung,
              Inhalt oder irgendeine Verbindung zu aserto auf Internetseiten
              Dritter.
            </p>
            <p>
              Außerdem behält sich aserto das Recht vor, Änderungen oder
              Ergänzungen der bereitgestellten Informationen vorzunehmen. Inhalt
              und Struktur der Internetseiten von aserto unterliegen dem
              ...
              bedarf der vorherigen schriftlichen Zustimmung von aserto oder des
        ...
        <li>
          <h3>
            Fotografie:{' '}
            <a href='https://volkercrone.com/' target='_blank' rel='noreferrer'>
              Volker Crone
            </a>
          </h3>
        </li>
